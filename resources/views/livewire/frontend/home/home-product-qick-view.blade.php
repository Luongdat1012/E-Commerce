<div class="wrap-modal1 js-modal1 p-t-60 p-b-20 show-modal1" id="modal1-quick">
                            ...
                            <div class="wrap-slick3 flex-sb flex-w">
                                ...
                                <div class="slick3 gallery-lb">
                                    ...
                                    @foreach($product->gallery as $photo)
                                        <div class="item-slick3"
                                             data-thumb="{{asset('uploads') . '/' . $photo->name}}">
                                            <div class="wrap-pic-w pos-relative">
                                    ...
                                    <div class="flex-w align-items-center p-b-10">
                                        ...
                                        <div class="size-204 respon6-next">
                                            <div class="rs1-select2 bor8 bg0">
                                                <select class="js-select2" onchange="checkQuantity()" name="quick_size"
                                                        id="quick_size">
                                            ...
                                            <div class="d-flex align-items-center">
                                                @foreach(json_decode($product->att_products)->colors as $item)
                                                    <div class="color-icon" data-color="{{$item}}"
                                                         ...
                                                         wire:click.prevent="checkQuantity()" onclick="showEvent()">
                                                    </div>
                                                @endforeach
                                    ...
                                    <div class="size-204 flex-w flex-m respon6-next">
                                        <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                            <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m"
                                                 id="quick-view-num-down" wire:click.prevent="decreaseQuantity()">
        ...
        <script>
            ...
            $(".js-hide-modal1").on("click", function () {
                ...
                $(`#home-body`).children('#modal1-quick').remove();
            });
